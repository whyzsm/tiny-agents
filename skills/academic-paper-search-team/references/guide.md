...
`$academic-paper-search-team` 论文检索专家团总入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$academic-paper-search-team` | 论文检索专家团工作流总入口 |
...
```text
$academic-paper-search-team 帮我检索多模态大模型评测相关论文，并整理关键文献清单

$academic-paper-search-team 监测最近一周 arXiv 和 PubMed 上关于具身智能的论文

$academic-paper-search-team 生成 GB/T 7714 格式参考文献和 BibTeX
```
