...
name: biostatistics
description: >-
  Biostatistics & Computational Analytics Skill. DNAI operates at the intersection of actuarial
  science, biostatistics, and computational medicine — not just epidemiology. - **Stochastic
  processes**: Markov chains, stochastic differential equations (SDE), diffusion models for
  disease progression - **Chaos theory in clinical modeling**: Lyapunov exponents, strange
  attractors, bifurcation analysis in immune system dynamics - **Propensity models via chaotic
  frameworks**: propensity score matching/weighting enhanced with non-linear dynamics, sensitivity
  to initial conditions, chaotic trajectory analysis for treatment response prediction
---
