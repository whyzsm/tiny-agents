---
name: bytesagain-copywriter-cn
description: Generate Chinese and English marketing copy using AIDA and A/B frameworks.
  Use when writing ad copy, drafting product descriptions, creating email campaigns,
  or generating brand slogans.
---
