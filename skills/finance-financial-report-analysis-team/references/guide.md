...
`$finance-financial-report-analysis-team` 财报分析专家团总入口
...
```text
$finance-financial-report-analysis-team 帮我完成一次财报分析，先判断需要哪些子技能
$finance-financial-report-analysis-team 根据这些资料生成完整交付物，并说明风险和假设
$finance-financial-report-analysis-team 只处理“获取A股/中国市场财务数据（获取层）”，给出结果和下一步建议
$finance-financial-report-analysis-team 把“补充美股/全球市场数据（获取层）”的结果整理成可交付报告
```
