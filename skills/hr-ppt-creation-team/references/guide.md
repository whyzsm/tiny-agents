...
`$hr-ppt-creation-team` PPT 制作专家团总入口
...
```text
$hr-ppt-creation-team 帮我完成一次PPT 制作，先判断需要哪些子技能
$hr-ppt-creation-team 根据这些资料生成完整交付物，并说明风险和假设
$hr-ppt-creation-team 只处理“PPT 大纲与结构规划（获取层）”，给出结果和下一步建议
$hr-ppt-creation-team 把“PowerPoint 文件全功能编辑（获取层）”的结果整理成可交付报告
```
