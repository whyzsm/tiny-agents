...
`$legal-contract-drafting-team` 合同起草专家团总入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$legal-contract-drafting-team` | 合同起草专家团工作流总入口 |
...
```text
$legal-contract-drafting-team 帮我起草一份合作协议，包含违约和争议解决条款

$legal-contract-drafting-team 根据这些素材生成 NDA 和服务协议初稿

$legal-contract-drafting-team 做一套合同模板和法律文书撰写指南

$legal-contract-drafting-team 起草一份税务相关法律意见书
```
