...
`$legal-contract-generation-team` 合同生成专家团总入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$legal-contract-generation-team` | 合同生成专家团工作流总入口 |
...
```text
$legal-contract-generation-team 帮我生成一份服务合同，并标出关键风险条款

$legal-contract-generation-team 根据这些商务条件起草合同正文和签署指引

$legal-contract-generation-team 生成劳动合同模板，并补充必要条款清单

$legal-contract-generation-team 输出合同正文、风险报告和附属文书
```
