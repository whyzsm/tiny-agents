...
`$legal-contract-review` 合同审查专家团总入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$legal-contract-review` | 合同审查专家团工作流总入口 |
...
```text
$legal-contract-review 审查这份 SaaS 合同，标出风险条款和缺失条款

$legal-contract-review 提取合同金额、付款节点、违约金和到期日

$legal-contract-review 对比两版合同差异并给出风险说明

$legal-contract-review 生成合同审查报告和修订建议清单
```
