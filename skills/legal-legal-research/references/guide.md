...
`$legal-legal-research` 法规检索专家团总入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$legal-legal-research` | 法规检索专家团工作流总入口 |
...
```text
$legal-legal-research 检索这个劳动纠纷相关法条和司法解释

$legal-legal-research 帮我定位这个法律概念的裁判标准和边界案例

$legal-legal-research 做类案检索，验证高频败诉原因

$legal-legal-research 梳理上位规范、并列条款和程序衔接关系
```
