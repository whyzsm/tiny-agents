...
`$legal-litigation-strategy-team` 诉讼策略专家团总入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$legal-litigation-strategy-team` | 诉讼策略专家团工作流总入口 |
...
```text
$legal-litigation-strategy-team 帮我梳理这个案件的争议焦点和应诉策略

$legal-litigation-strategy-team 根据这些证据做证据矩阵和诉讼时间线

$legal-litigation-strategy-team 估算诉讼成本并生成文书骨架

$legal-litigation-strategy-team 起草一份民事起诉状并列出材料清单
```
