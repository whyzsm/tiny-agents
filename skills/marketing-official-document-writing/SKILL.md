---
name: marketing-official-document-writing
description: 从符合GB/T 9704-2012标准的党政机关公文全类型生成（通知/报告/请示/批复/函/会议纪要/公告/决定等15种）、国家标准格式规范与各类公文模板写作技巧、素材重构与主题创作双模式，到公文格式检查/语气检查/模板库、中国公文格式Word文档自动生成（标题分级/字体样式/段落格式/中文引号）、公文规范自动排版的完整公文写作工作流。
---

# 公文写作

Use this skill as the routing entry point for the 公文写作 workflow. It coordinates the companion skills in this bundle instead of replacing them.
