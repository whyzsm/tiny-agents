---
name: marketing-user-growth
description: 从AARRR+增长框架与北极星指标定义、获客闭环与实验框架设计、转化漏斗创建与流失环节诊断，到新用户入职流程与激活指标优化、客户留存策略与赢回活动设计、流失风险AI评估与定制化留存推荐的完整用户增长工作流。覆盖获客、激活、留存、转化、推荐全链路增长体系。
---

# 用户增长

Use this skill as the routing entry point for the 用户增长 workflow. It coordinates the companion skills in this bundle instead of replacing them.
