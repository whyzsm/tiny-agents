---
name: nathan-legal-os-pro
description: >-
  Comprehensive legal document automation for clause extraction, document summarization,
  legal research, deadline tracking, contract analysis, regulatory workflows, and legal
  operations support.
---
