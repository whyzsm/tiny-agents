---
name: price-hunter
description: Global price comparison tool with international platform support. Compare
  prices across Amazon, eBay, AliExpress, Temu (international) AND JD, Taobao, Tmall,
  Pinduoduo (China). Best for cross-border shopping, finding the cheapest option globally,
  or checking if buying abroad is cheaper than domestic. Triggers on "比价XXX", "where
  is XXX cheapest globally", "compare Amazon vs JD", "海外比价", "XXX国内买还是国外买".
---
