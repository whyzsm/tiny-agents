...
description: Price a product or service for a solopreneur business. Use when deciding
  how much to charge, choosing between pricing models, structuring tiers, handling
  price objections, and adjusting prices over time. Covers value-based pricing, competitor
  benchmarking, psychological pricing tactics, pricing tiers design, and price testing.
  Trigger on "how should I price this", "pricing strategy", "what should I charge",
  "pricing tiers", "am I undercharging", "pricing model", "how to price my product",
  "raise my prices".
---
