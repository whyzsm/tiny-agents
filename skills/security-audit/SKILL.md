...
Prefer repository-local evidence and built-in tools first. Do not run destructive remediation or auto-fix commands unless the user explicitly asks for changes.
