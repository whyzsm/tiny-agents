...
`$tech-bug-troubleshooting-team` BUG 排查专家团

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$tech-bug-troubleshooting-team` | 端到端 BUG 排查工作流总入口 |
...
```text
$tech-bug-troubleshooting-team 帮我排查这个接口 500，下面是日志和请求参数

$tech-bug-troubleshooting-team 这个测试突然失败了，请复现、定位根因并修复

$tech-bug-troubleshooting-team 分析这段堆栈，找出是哪条代码路径导致空指针

$tech-bug-troubleshooting-team 用多 agent 帮我排查这个线上回归，最后给出根因和验证结果
```
