...
`$tech-code-refactoring-team` 端到端代码重构工作流入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$tech-code-refactoring-team` | 完整代码重构工作流总入口 |
...
```text
$tech-code-refactoring-team 分析这个模块的复杂度和技术债务，给出重构优先级

$tech-code-refactoring-team 按 SOLID 和 Clean Architecture 评审这批代码并输出重构计划

$tech-code-refactoring-team 把这个臃肿服务拆成清晰模块，保留现有行为

$tech-code-refactoring-team 简化最近改动的代码，运行相关测试并说明验证结果
```
