...
`$tech-code-review-team` 端到端代码审查工作流入口

## 触发的技能

| 技能 | 能力 |
|---|---|
| `$tech-code-review-team` | 完整代码审查工作流总入口 |
...
```text
$tech-code-review-team review 这个 PR，重点看安全、错误处理和测试覆盖

$tech-code-review-team 严格审查最近的 git diff，按阻塞/必须修/建议分类

$tech-code-review-team 检查这段 TypeScript 有没有潜在 bug、性能问题和类型安全问题

$tech-code-review-team 输出中文 Review 报告，包含文件位置、风险等级和修复建议
```
